...
export default class ShortcutsService {
    ...
    async updateShortcuts(document: OCRDocument) {
        try {
            ...
            const nlist = androidx.core.content.pm.ShortcutManagerCompat.getDynamicShortcuts(context);
            ...
            const result = androidx.core.content.pm.ShortcutManagerCompat.setDynamicShortcuts(context, finalList);
    ...
    removeShortcut(context, documentId) {
        androidx.core.content.pm.ShortcutManagerCompat.removeDynamicShortcuts(context, java.util.Collections.singletonList(documentId));
    }
    ...
    async createShortcutBuilder(context, document: OCRDocument) {
        ...
        return new androidx.core.content.pm.ShortcutInfoCompat.Builder(context, document.id).setShortLabel(document.name).setLongLabel(document.name).setIntent(intent).setIcon(icon);
    }
}
